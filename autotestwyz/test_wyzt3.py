...
class TestAssistantSample(object):
    ...
    @allure.step(title='将获取到的cookie放入消息中心首页')
...
'''
    ...
    ggmsg1 = driver.find_element_by_class_name("setTipAlertCon").text
    print("公告大事"+ggmsg1)
    assert ggmsg1 == "订阅成功"
    time.sleep(2)
    ...
    # 点击公告大事按钮取消订阅
    driver.find_element_by_xpath("//*[@id=\"customSetColumn\"]/div/ul/li[2]/div/label/i").click()
    ggmsg2 = driver.find_element_by_class_name("setTipAlertCon").text
    print("公告大事"+ggmsg2)
    assert ggmsg2 == "退订成功"
    time.sleep(2)
    ...
    thslcmsg1 = driver.find_element_by_class_name("setTipAlertCon").text
    ...
    #点击同花顺理财取消订阅
    driver.find_element_by_xpath("//*[@id=\"customSetColumn\"]/div/ul/li[3]/div/label/i").click()
    thslcmsg2 = driver.find_element_by_class_name("setTipAlertCon").text
    ...
    wcmsg1 = driver.find_element_by_class_name("setTipAlertCon").text
    print("问财"+wcmsg1)
    assert wcmsg1 == "订阅成功"
    time.sleep(2)
    ...
    #退订问财
    driver.find_element_by_xpath("//*[@id=\"customSetColumn\"]/div/ul/li[4]/div/label/i").click()
    wcmsg2 = driver.find_element_by_class_name("setTipAlertCon").text
    print("问财"+wcmsg2)
    assert wcmsg2 == "退订成功"
    time.sleep(2)
    ...
    #点击再次问财订阅
    driver.find_element_by_xpath("//*[@id=\"customSetColumn\"]/div/ul/li[4]/div/label/i").click()
    wcmsg3 = driver.find_element_by_class_name("setTipAlertCon").text
    print("问财再次"+wcmsg3)
    assert wcmsg3 == "订阅成功"
    time.sleep(2)
    wctc = driver.find_element_by_class_name("znxgAlertTip").is_displayed()
    ...
    #再次退订问财
    driver.find_element_by_xpath("//*[@id=\"customSetColumn\"]/div/ul/li[4]/div/label/i").click()
    wcmsg4 = driver.find_element_by_class_name("setTipAlertCon").text
    print("问财再次"+wcmsg4)
    assert wcmsg4 == "退订成功"
    time.sleep(2)
    ...
    #时间判断
    print(driver.find_element_by_xpath("/html/body/section[1]/div[1]/div[3]/h5/span").text)
